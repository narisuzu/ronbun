...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \draw[thick, -stealth] (P') -- ($(P')!1cm!(fu)$) node[left] {$\va{E}_-$};
        \draw[thick, -stealth] (P') -- ($(P')!-1cm!(zh)$) node[left] {$\va{E}_+$};
        \draw[thick, -stealth] (P') -- +(180: 0.3714cm) node[left] {$\va{E}$};

        \draw[thick, -stealth]  (P) -- +(0: 1cm) node[above] {$\va{E}_+$};
        \draw[thick, -stealth]  (P) -- +(180: 0.6cm) node[above] {$\va{E}_-$};
        \draw[thick, -stealth]  (P) -- +(0: 0.4cm) node[above] {$\va{E}$};
