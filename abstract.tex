\null
\begin{abstract}\normalsize
    车站联锁能够保证行车安全、提高运行效率，当下，在车站联锁系统中，
...
\end{abstract}
\twolines
\noindent\textbf{Keywords：} Distributed systems；Web application；GraphQL；Rust Programming Language；Computer-based interlocking
\clearpage